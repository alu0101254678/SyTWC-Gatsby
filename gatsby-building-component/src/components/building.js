...
const Building = ({ bien }) => {
  return (
    ...
    <div style={{ 
      ...
      * Tipo de arquitectura y época del edificio <p>{`${bien.tipo.arquitectura} - ${bien.tipo.época}`}</p> 
      * Imagen del edificio <img src={bien.img} alt={bien.nombre} style={{ width: '100%', height: 'auto' }} /> 
